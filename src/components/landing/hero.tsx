            ...
            <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center relative z-10">
                ...
                <div className="space-y-8 text-center lg:text-left">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm">
                        ...
                        <span className="text-sm font-medium text-starlight tracking-wide">AI-Powered Learning V.1.0</span>
                    </div>

                    <h1 className="text-5xl lg:text-7xl font-bold tracking-tight font-heading leading-tight">
                        Trải nghiệm <br />
                        <span className="text-gradient">Học lập trình</span> cùng AI
                    </h1>

                    <p className="text-xl text-slate-400 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                        Học lập trình không còn khó khăn. <span className="text-accent-secondary">AI Coding Guru</span> giúp bạn bắt đầu thật dễ dàng và vững chắc.
                    </p>
                    ...
                    <div className="flex flex-row gap-3 mt-10 w-full lg:max-w-[80%]">
                        <div className="glass-panel p-2.5 rounded-xl flex-1 flex flex-col items-center justify-center gap-2 border border-white/10 transition-all hover:bg-white/10 hover:-translate-y-1 duration-300 text-center group">
                            ...
                            <div>
                                <div className="text-[10px] text-slate-400 font-medium uppercase tracking-wider">Debugger</div>
                                <div className="text-xs font-bold text-starlight">Auto-Fix</div>
                            </div>
                        </div>
                        ...
                        <div className="glass-panel p-2.5 rounded-xl flex-1 flex flex-col items-center justify-center gap-2 border border-white/10 transition-all hover:bg-white/10 hover:-translate-y-1 duration-300 text-center group">
                            ...
                            <div>
                                <div className="text-[10px] text-slate-400 font-medium uppercase tracking-wider">Quiz</div>
                                <div className="text-xs font-bold text-starlight">Interactive</div>
                            </div>
                        </div>
                        ...
                        <div className="glass-panel p-2.5 rounded-xl flex-1 flex flex-col items-center justify-center gap-2 border border-white/10 transition-all hover:bg-white/10 hover:-translate-y-1 duration-300 text-center group">
                            ...
                            <div>
                                <div className="text-[10px] text-slate-400 font-medium uppercase tracking-wider">Career</div>
                                <div className="text-xs font-bold text-starlight">Job-Ready</div>
                            </div>
                        </div>
                    </div>
                </div>
