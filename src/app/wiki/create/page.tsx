    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (data.success) {
                ...
                setError(data.error || "Không thể đăng bài. Vui lòng thử lại.");
            }
        } catch (err) {
        ...
        <main className="min-h-screen pt-32 pb-20 px-4 relative z-10">
            ...
            <div className="container mx-auto max-w-4xl">
                ...
                <header className="mb-12">
                    <h1 className="text-4xl font-bold text-white mb-2">Soạn bài viết mới</h1>
                    <p className="text-white/60">Nội dung sẽ được hiển thị ngay sau khi bạn nhấn đăng bài.</p>
                </header>
